...
app.route("/api/vaccinations")
    .get(controller.getVaccinations)
    .post(controller.saveVaccination)

app.route("/api/vaccinations/:id")
    .get(controller.getVaccination)

app.route("/api/persons/:personal_number")
